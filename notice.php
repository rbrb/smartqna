...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						<li><a href="basicInfo.php"><i class="fa fa-dashboard fa-fw"></i>
								기본정보</a></li>
						<li><a href="approval.php"><i class="fa fa-bar-chart-o fa-fw"></i>
								매출 및 결제 정보</a></li>
						<li><a href="EnterSales.php"><i class="fa fa-table fa-fw"></i> 매출
								입력</a></li>
						<li><a href="notice.php"><i class="fa fa-bell fa-fw"></i> 공지사항</a>
						</li>
					</ul>
				</div>
				<!-- /.sidebar-collapse -->
			...
			<!-- /.navbar-static-side -->
			<a href="agent.php"
				style="position: absolute; right: 12px; top: 22px;"> logout </a>
		</nav>
