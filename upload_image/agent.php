	...
	<div class="tabs">
		...
		<div class="tab-content">
			...
			<div id="tab0" class="tab active">
				<dl>
					<dt> 아이디 </dt>
						<dd> <? echo $_SESSION['login_user']; ?> </dd>
					<dt>회사이름</dt>
					 	<?
						...
						?>
					 <dt>대표자이름</dt> 	<? echo "<dd>$agent[name]</dd>"; ?>
					 <dt>연락처</dt> 			<? echo "<dd>$agent[hp]</dd>"; ?>
					 <dt>담당지역</dt>		<? echo "<dd>$agent[lv0]/$agent[lv1]</dd>"; ?>
					<dd></dd>
				</dl>
			</div>
			<!--tab0-->
...
function contractCtr($scope,$http) {
	...
	$scope.editContract = function(contract){
		alert('edit:' + contract.name + ":" +contract.id);
